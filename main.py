...
run_astar(med_dict, heuristics.free_moves2, "medium level")
run_astar(med_dict, heuristics.free_moves3, "medium level")
# run_bfs(med_dict, "medium level")
# run_astar(hard_dict, heuristics.free_moves2, "hard level")
